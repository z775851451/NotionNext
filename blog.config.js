...
const BLOG = {
  ...
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || 'be1cd233dd6f435ca65e9db95b57bc2f',
  ...
  // utterance
  COMMENT_UTTERRANCES_REPO: process.env.NEXT_PUBLIC_COMMENT_UTTERRANCES_REPO || 'z775851451/NotionNext', // 你的代码仓库名， 例如我是 'tangly1024/NotionNext'； 更多文档参考 https://utteranc.es/

  // giscus @see https://giscus.app/
  COMMENT_GISCUS_REPO: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO || 'z775851451/NotionNext', // 你的Github仓库名 e.g 'tangly1024/NotionNext'
  ...
  // 作废配置
  AVATAR: '/0E1FEA19-FD86-46F6-AC02-6C089F61000A.ico', // 作者头像，被notion中的ICON覆盖。若无ICON则取public目录下的avatar.png
